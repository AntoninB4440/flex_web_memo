export default class Coopernet {
   ...
   *  - instancier la class (fait)
   *  - appeler la méthode getToken (fait)
   *  - appeler la méthode getUser (fait)
   *  - appeler la méthode getTerms va renvoyer un tableau d'objets qui donnent (fait)
